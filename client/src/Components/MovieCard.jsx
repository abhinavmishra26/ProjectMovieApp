  ...
  return (
    <div className='w-66 bg-gray-800 p-3 rounded-2xl'>
      ...
      <div className='flex justify-between mb-2' >
        <button  className='w-26 bg-primary text-white p-1 h-8  rounded-2xl  text-sm cursor-pointer hover:bg-red-400 ' onClick={()=>{navigate(`/movies/${movie._id}`);scrollTo(0,0)}}>Buy Ticket</button>
